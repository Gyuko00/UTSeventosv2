<div class="bg-gradient-to-r from-lime-600 to-lime-700 rounded-xl shadow-lg p-6 mb-6 flex justify-between items-center">
  <div>
    <h1 class="text-3xl font-bold text-white mb-1">Editar Usuario</h1>
    <p class="text-lime-100 text-sm opacity-90">Actualiza la información del usuario en el sistema</p>
  </div>
  
  <a href="<?= URL_PATH ?>/admin/listarUsuarios"
    ...
    <!-- SVG de flecha hacia la izquierda -->
