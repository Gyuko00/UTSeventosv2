<?php
// app/modules/admin/components/ponentes_evento/home/tabla.php
?>
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden border border-lime-200">
  <div class="overflow-x-auto">
    <table class="w-full">
      ...
      <tbody id="tablaPonentesEvento" class="bg-white divide-y divide-lime-100 hover:divide-lime-200">
        <?php if (empty($ponentes)): ?>
        <?php include_once __DIR__ . '/tabla/empty_state.php'; ?>
        <?php else: ?>
        <?php foreach ($ponentes as $ponente): ?>
        <?php include __DIR__ . '/tabla/ponente_evento_row.php'; ?>
        <?php endforeach; ?>
        <?php endif; ?>
      </tbody>
    </table>
