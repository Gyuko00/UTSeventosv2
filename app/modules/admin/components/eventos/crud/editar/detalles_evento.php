  ...
  <div class="space-y-6">
    <div>
      ...
      <p class="text-sm text-gray-500 mt-1">
        Proporciona información detallada que ayude a los participantes a
        entender de qué se trata el evento
      </p>
    </div>
    ...
    <div class="space-y-4">
      ...
      <input type="hidden" id="hora_inicio" name="event[hora_inicio]" value="<?= htmlspecialchars($evento['hora_inicio'] ?? '') ?>" required />
      <input type="hidden" id="hora_fin" name="event[hora_fin]" value="<?= htmlspecialchars($evento['hora_fin'] ?? '') ?>" required />
...
<script>
  ...
  window.EVENTO_ID = <?= (int)$evento['id_evento'] ?>;
</script>
