<div class="flex justify-end space-x-2">
  <a
    href="<?= URL_PATH ?>/admin/detalleEvento/<?= $evento['id_evento'] ?>"
  ...
  <a
    href="<?= URL_PATH ?>/admin/editarEvento/<?= $evento['id_evento'] ?>"
  ...
  <button
    onclick="eliminarEvento(<?= $evento['id_evento'] ?>, '<?= htmlspecialchars($evento['titulo_evento']) ?>')"
