...
<a href="<?= URL_PATH ?>/admin/detalleUsuario/<?= $usuario['id_usuario'] ?>" 
   class="text-blue-600 hover:text-blue-900 mr-3 inline-flex items-center" title="Ver detalle">
...
<a href="<?= URL_PATH ?>/admin/editarUsuario/<?= $usuario['id_usuario'] ?>" 
   class="text-indigo-600 hover:text-indigo-900 mr-3 inline-flex items-center" title="Editar">
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
